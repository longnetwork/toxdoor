...
# flags '--doc --show-definition-location --clang-args=-I/usr/lib/gcc/x86_64-linux-gnu/9/include/ -I./c-toxcore/toxcore/ -target x86_64-linux-gnu c-toxcore/toxcore/tox_log_level.h c-toxcore/toxcore/tox_options.h c-toxcore/toxcore/tox.h -t x86_64-linux-gnu -o tox_lin.py'
# -*- coding: utf-8 -*-
#
# TARGET arch is: ['-target', 'x86_64-linux-gnu', '-I/usr/lib/gcc/x86_64-linux-gnu/9/include/', '-I./c-toxcore/toxcore/', '-target', 'x86_64-linux-gnu']
# WORD_SIZE is: 8
# POINTER_SIZE is: 8
